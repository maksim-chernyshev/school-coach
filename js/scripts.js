...
var swiper5 = new Swiper('.main-caption .swiper-container', {
    slidesPerView: 3,
    spaceBetween: 30,
    autoHeight: false,
    loop: false,
    ...
    navigation: {
        nextEl: '.main-caption .swiper-button-next',
        prevEl: '.main-caption .swiper-button-prev'
    }
});

var swiper6 = new Swiper('.tarifs .swiper-container', {
    slidesPerView: 3,
    spaceBetween: 30,
    autoHeight: false,
    loop: false,
    ...
    navigation: {
        nextEl: '.tarifs .swiper-button-next',
        prevEl: '.tarifs .swiper-button-prev'
    }
});
...
$(document).ready(function () {
    ...
    $('.more-button').on('click', function () {
        ...
        const tarifWrapper = $('.swiper-wrapper')
